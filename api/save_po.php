...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // 5. ดึง ID ล่าสุดมาเจนเลขที่เอกสาร (สไตล์เดียวกับ PR)
        $po_id = mysqli_insert_id($conn);
        $date_prefix = date('ymd'); // จะได้ 260305 (ปี 26 เดือน 03 วันที่ 05)
        
        // รูปแบบ PO-260305000001 (เลข ID รัน 6 หลัก)
        $doc_no = "PO-" . $date_prefix . str_pad($po_id, 6, '0', STR_PAD_LEFT);
