    ...
    <form action="api/save_milestone.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-slate-500 text-sm">โครงการ: <span class="text-indigo-600 font-bold"><?= $pj['project_no'] ?> - <?= $pj['project_name'] ?></span></p>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-slate-100">
                        ...
                        <div class="p-4 bg-slate-50 rounded-xl border border-slate-100">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <input type="checkbox" id="use_wht" checked onchange="calculateMoney()" class="rounded text-rose-500">
                            </div>
                ...
                <div class="bg-white rounded-2xl -sm border border-slate-200 p-6">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-blue-50 border border-blue-100 rounded-2xl">
                        ...
                        <div>
                            <p class="text-sm font-bold text-slate-700"><?= $pj['bank_name'] ?>: <span class="text-blue-700 font-black"><?= $pj['bank_account_no'] ?></span></p>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-slate-900 rounded-3xl p-6 text-white -xl">
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <div class="flex justify-between font-black text-lg pt-2 mt-2 border-t border-dashed border-slate-700">
